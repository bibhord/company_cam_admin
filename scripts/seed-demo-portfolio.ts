...
const VERTICALS: Record<string, VerticalConfig> = {
  ...
  photographer: {
    ...
    org_name: 'Crestview Photography',
    admin_email: 'demo-photographer@captureyourwork.com',
    first_name: 'Sam',
    last_name: 'Demo',
    projects: [
      {
        name: '4218 Hillside Dr · Modern Family Home',
        street_address: '4218 Hillside Drive',
        city: 'Salt Lake City',
        state_zip: 'UT 84103',
        lat: 40.7766,
        lng: -111.853,
        photo_queries: ['modern home exterior dusk', 'luxury living room interior', 'modern kitchen marble island', 'master bedroom modern', 'modern bathroom shower', 'backyard pool sunset'],
        before_after_pair: false,
      },
      {
        name: '120 W South Temple · Downtown Loft',
        street_address: '120 W South Temple',
        city: 'Salt Lake City',
        state_zip: 'UT 84101',
        lat: 40.769,
        lng: -111.893,
        photo_queries: ['downtown loft windows', 'industrial loft kitchen', 'loft bedroom exposed brick', 'modern bathroom dark tile', 'city skyline window view', 'loft entryway concrete'],
        before_after_pair: false,
      },
      {
        name: '892 E Forest Glen · Mountain Estate',
        street_address: '892 E Forest Glen',
        city: 'Park City',
        state_zip: 'UT 84060',
        lat: 40.6461,
        lng: -111.4977,
        photo_queries: ['mountain home aerial', 'log cabin interior fireplace', 'mountain home great room', 'mountain home kitchen wood'],
        before_after_pair: false,
      },
    ],
  },
