    ...
    <div className="space-y-6">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          <div className="flex flex-1 items-center gap-2 min-w-0">
            <input
              ...
              className="flex-1 min-w-0 rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
            />
            <span className="shrink-0 text-xs text-slate-500 lg:text-sm">.{ROOT}</span>
          </div>
          <button
            onClick={saveSlug}
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4 lg:p-6">
        <div className="flex flex-wrap items-end justify-between gap-2">
          ...
          <p className={`text-xs font-semibold whitespace-nowrap ${eligible ? 'text-emerald-600' : 'text-amber-600'}`}>
