        ...
        {loading ? (
          ...
          <div className="pt-4 space-y-4">
            ...
            <button
              ...
              disabled={uploading}
              className="flex w-full items-center gap-4 rounded-2xl bg-white p-5 shadow-sm border-2 border-amber-400 active:bg-amber-50 transition-colors disabled:opacity-60"
            >
